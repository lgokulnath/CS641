...
int main()
{
    // input as in byte values
    vector<int> inp = {55, 140, 164, 254, 33, 181, 176, 33};
    vector<int> inp2 = { 88, 111,149, 180, 195, 149, 196, 52 };
    vector<ll> input;
    for(int i = 0; i < inp.size(); i++) {
        for(int j = 7; j >= 0; j--) {
            input.push_back((inp[i] >> j) & 1 );
        }
    }
